...
def update_topic(topic_value, checklist_value, infocheck_value):
    ...
    if topic_value in output_data:
        ...
        def_element = create_elements(sen1, sen2, output_data[topic_value]['relation_BAF'], attack, nonattack, show_node_label)
        devin_element = create_elements(sen1, sen2, output_data[topic_value]['gpt_davinci'], attack, nonattack, show_node_label)
        gpt35_element = create_elements(sen1, sen2, output_data[topic_value]['gpt_35'], attack, nonattack, show_node_label)
        gpt350613_element = create_elements(sen1, sen2, output_data[topic_value]['gpt_35_0613'], attack, nonattack, show_node_label)
